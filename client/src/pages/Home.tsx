...
const i18n = {
  zh: {
    ...
    aiHowTitle: 'AI 如何工作',
    aiSteps: [
      { step: '01', title: '实时监控', desc: '持续追踪 NVDY 波动率、期权溢价、市场情绪指数及各资产相关性变化', items: ['NVDY IV 波动率', '期权溢价 / 折价', '市场情绪指数'] },
      { step: '02', title: '智能判断', desc: '当关键指标偏离阈值时触发调仓信号，结合历史数据评估最优配比', items: ['波动率超阈值触发', '派息率偏离均值', '相关性异常检测'] },
      { step: '03', title: '自动执行', desc: '在风控框架内自动调整各资产权重，并将派息收益按策略再分配', items: ['仓位自动再平衡', '派息智能再投资', '风控边界强制执行'] },
    ],
  ...
  en: {
    ...
    navNote: 'Includes NAV Growth + Cash Distribution',
    cashflowTitle: 'Cash Flow Calendar (Monthly)',
    week: (n: number) => `Week ${n}`,
    nvdyDist: 'NVDY Distribution',
    nvdyQqqiDist: 'NVDY + QQQI Distribution',
    ...
    tableTitle: 'Holdings & Distribution Frequency',
    ...
    signals: [
      ...
      { label: 'Options Premium', value: 'Elevated' },
    ...
    aiSteps: [
      { step: '01', title: 'Monitor', desc: 'Continuously tracks NVDY implied volatility, options premium, market sentiment, and cross-asset correlations', items: ['NVDY IV Volatility', 'Options Premium / Discount', 'Market Sentiment Index'] },
      { step: '02', title: 'Analyze', desc: 'Triggers rebalancing signals when key metrics deviate from thresholds, evaluating optimal allocation using historical data', items: ['Vol. Threshold Trigger', 'Yield Deviation Alert', 'Correlation Anomaly'] },
      { step: '03', title: 'Execute', desc: 'Automatically adjusts asset weights within risk boundaries and redistributes distribution income per strategy', items: ['Auto Position Rebalance', 'Smart Distribution Reinvest', 'Risk Boundary Enforcement'] },
    ],
    fn1: { strong: 'Disclaimer: ', text: 'Projections are based on historical distribution levels. NVDY is a covered-call ETF; dividends are subject to NVDA price volatility and are not guaranteed. Consider reinvesting excess cash flow to offset potential NAV erosion.' },
    ...
    sellingPoints: [
      ...
      { title: 'Steady Growth',     desc: 'Dual-engine: distributions + NAV growth compound over time' },
    ],
    portfolio: [
      ...
      { aiReason: 'QQQI options premium widened; AI added exposure to capture higher premium income', tagline: 'Nasdaq core + monthly dist. — $9.18B AUM backs steady returns' },
