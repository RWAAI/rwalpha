...
const i18n = {
  ...
  en: {
    ...
    aumSource: 'Data Source: TradingView',
    colTicker: 'Ticker',
    colAum: 'AUM (USD)',
    colYield: 'Yield',
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-8 pb-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 rounded-3xl shadow-lg text-white">
            ...
            <div className="mt-4">
              <p className="text-3xl font-bold">{metrics.yield}%<sup className="text-base font-normal ml-0.5">*</sup></p>
          ...
          <div className={`${t.card} p-6 rounded-3xl shadow-sm border transition-colors duration-300`}>
            ...
            <div className="mt-4">
              <p className={`text-3xl font-bold ${t.title}`}>{metrics.return}%<sup className="text-base font-normal ml-0.5">*</sup></p>
          ...
          <div className={`${t.card} p-6 rounded-3xl shadow-sm border transition-colors duration-300`}>
            ...
            <div className="mt-3">
              <p className={`text-3xl font-bold ${t.title}`}>${parseInt(metrics.totalWeekly).toLocaleString()}<sup className="text-base font-normal ml-0.5">*</sup></p>
