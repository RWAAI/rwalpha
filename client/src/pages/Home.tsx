...
const i18n = {
  ...
  en: {
    ...
    aiSteps: [
      ...
      { step: '03', title: 'Execute', desc: 'Automatically adjusts weights across NVDY/QQQI/QQQM/VGT within risk boundaries and redistributes distribution income per strategy', items: ['4-Asset Auto Rebalance', 'Smart Distribution Reinvest', 'Risk Boundary Enforcement'] },
    ],
