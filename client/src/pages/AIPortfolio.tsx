...
const T = {
  zh: {
    ...
    oneYearReturn: '1年总回报（含派息）',
    weightedAvg: '加权平均',
    weeklyIncome: '每周到账 (10万本金)',
    annualIncome: '年收息',
    // Card header
    dividendRate: '派息率',
    oneYearReturnShort: '1年回报（含派息）',
    volatility: '波动率',
    refreshData: '刷新数据',
    editPortfolio: '编辑组合',
    // Cash flow
  ...
  en: {
    ...
    oneYearReturn: '1Y Total Return (incl. Dividends)',
    weightedAvg: 'Weighted Avg',
    weeklyIncome: 'Weekly Income ($100K)',
    annualIncome: 'Annual Income',
    dividendRate: 'Yield',
    oneYearReturnShort: '1Y Return (incl. Div.)',
    ...
    colAum: 'AUM (USD)',
    colYield: 'Yield',
    colReturn: 'Total Return (incl. Div.)',
