...
const CATEGORIES = [
  ...
  },
  {
    ...
    descZh: "对 NVDY、QQQI、QQQM、VGT 等核心持仓的深度拆解，包括历史派息数据、费率对比与底层资产分析。",
    descEn: "In-depth breakdowns of NVDY, QQQI, QQQM, VGT and more — historical dividends, fee comparisons, and underlying asset analysis.",
    tagZh: "即将上线",
    tagEn: "Coming Soon",
        ...
        <section className="bg-gradient-to-br from-indigo-600 to-violet-600 mx-6 mb-14 rounded-2xl max-w-4xl md:mx-auto">
          <div className="px-8 py-10 text-center">
            ...
            <p className="text-indigo-200 text-sm mb-6">
              {zh
                ? "rINDEX 金库已上线，AI 驱动调仓 · 每周现金派息 · 指数底仓增值"
                : "rINDEX Vault is live — AI rebalancing, weekly dividends, index core growth"}
            </p>
            <a
              href="/vault"
