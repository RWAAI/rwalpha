...
const COPY = {
  zh: {
    ...
    heroTitle1: '当 AI 遇上',
    heroTitle2: '真实世界资产',
    heroSub1: '底层持有真实一篮子 ETF，AI 实时优化仓位，',
  ...
  en: {
    ...
    heroSub1: 'A basket of real ETFs as collateral, AI optimizes positions in real time,',
    heroSub2: 'yield distributed weekly. On-chain, transparent, verifiable.',
    cta1: 'View Vault Data',
    cta2: 'Launch App',
    trust: ['On-chain Verifiable', 'Institutional Custody', 'T+3 Redemption', 'Weekly Auto-Yield'],
    featuresLabel: 'Four Core Advantages',
    features: [
      { title: 'Weekly Yield', desc: 'Options income distributed mechanically every week — stable cash flow, not market-dependent.' },
      ...
      { title: 'Steady Growth', desc: 'Yield + NAV appreciation on dual tracks. Compounding drives continuous asset growth.' },
    ],
    statsLabel: 'Live Metrics',
    stats: [
      { label: 'Annual Yield Rate', suffix: '%' },
    ...
    howSub: 'From subscription to weekly yield — fully on-chain, no trust required.',
    steps: [
      ...
      { step: '03', title: 'Receive Weekly Yield', desc: 'Options income auto-distributed to your wallet weekly, or reinvested for compounding.' },
    ],
    ctaTitle: 'Ready to Let AI Manage Your Portfolio?',
    ctaSub: 'Institutional strategy. On-chain transparency. Weekly yield. Start now.',
    ctaBtn1: 'Enter Vault',
