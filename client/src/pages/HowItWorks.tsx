...
const COPY = {
  zh: {
    ...
    flowNodes: {
      ...
      fomo: 'OTC', fomoSub: '稳定币 → USD',
      fomoRev: 'OTC', fomoRevSub: 'USD → 稳定币',
  ...
  en: {
    ...
    signals: [
      ...
      { label: 'Index Core Momentum', value: 'Strong' },
      { label: 'Suggested Direction', value: 'Hold Current Allocation' },
    ],
    aiLogTitle: 'AI Rebalancing Log',
    logs: [
      { date: '2026-03-10', icon: '⚖️', action: 'Income Asset A vol. rose; weight trimmed from 25% to 22%, diff. added to Index Core', tag: 'Rebalance' },
      { date: '2026-03-07', icon: '💰', action: 'Weekly dist. $283 received; AI auto-reinvested 60% into Income Asset B', tag: 'Reinvest' },
      { date: '2026-03-03', icon: '📊', action: 'Options premium rebounded to hist. mean +1σ; Income Asset A weight restored to 22%', tag: 'Rebalance' },
      { date: '2026-02-24', icon: '🛡️', action: 'Market volatility surged; Tech Core weight raised 2% for defensive positioning', tag: 'Risk Ctrl' },
    ],
    ...
    flowNodes: {
      ...
      fomo: 'OTC', fomoSub: 'Stablecoin → USD',
      fomoRev: 'OTC', fomoRevSub: 'USD → Stablecoin',
